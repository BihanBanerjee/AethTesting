...
import { Badge, Code, FileText } from 'lucide-react';
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center overflow-x-auto pb-2 mb-2 custom-scrollbar-x">
        {props.filesReferences.map((file, index) => {
          ...
          const isGeneratedCode = file.fileName.includes('generated-') || 
                                 file.summary.includes('Generated') ||
                                 file.summary.includes('generated');
          ...
          return (
            <button
              ...
              className={`px-3 py-1.5 text-sm font-medium rounded-md transition-colors whitespace-nowrap mr-2 flex items-center gap-2 ${
            ...
            >
              ...
              {isGeneratedCode && (
                <Badge variant="outline" className="text-xs border-green-500/30 text-green-300 ml-1">
                  Generated
                </Badge>
              )}
            </button>
          ...
          return (
            <div key={file.fileName} className="h-full flex flex-col">
              <div className="p-2 bg-indigo-800/40 border-b border-indigo-500/20 text-white rounded-t-md flex justify-between items-center">
                ...
                <span className="text-xs text-white/60 italic flex items-center gap-1">
                  {isGeneratedCode ? (
                    <>
